            ...
            <div class="video-item">
               <div class="item-thumbnail">
                  <a href="movie/sexy-spy-sumire-matsu-takes-load-of-cum-in-her-pussy.1184.html" title="Sexy Spy Sumire Matsu Takes Load of Cum in Her Pussy" >
                     <img src="{{ URL::asset('images/movies/phim18.fun-sexy-spy-sumire-matsu-takes-load-of-cum-in-her-pussy.jpg') }}" width="748" height="421" alt="Sexy Spy Sumire Matsu Takes Load of Cum in Her Pussy">
               ...
               <div class="video-item">
                  <div class="item-thumbnail">
                     <a href="movie/suzu-minamoto-with-big-butt-is-screwed.1196.html" title="Suzu Minamoto with big butt is screwed" >
                        <img src="{{ URL::asset('images/movies/phim18.fun-suzu-minamoto-with-big-butt-is-screwed.jpg') }}" width="356" height="200" alt="Suzu Minamoto with big butt is screwed">
                        <div class="link-overlay glyphicon glyphicon-play-circle"></div>
                     </a>
                     <div class="item-head">
               ...
               <div class="video-item">
                  <div class="item-thumbnail">
                     <a href="movie/suzu-minamoto-sucks-dick-while-gets-cock.1166.html" title="Suzu Minamoto sucks dick while gets cock" >
                        <img src="{{ URL::asset('images/movies/phim18.fun-suzu-minamoto-sucks-dick-while-gets-cock.jpg') }}" width="356" height="200" alt="Suzu Minamoto sucks dick while gets cock">
                        <div class="link-overlay glyphicon glyphicon-play-circle"></div>
                     </a>
                     <div class="item-head">
               ...
               <div class="video-item">
                  <div class="item-thumbnail">
                     <a href="movie/marika-s-japan-girl-blowjob-ends-in-a-pussy-creampie.1159.html" title="Marika's japan girl blowjob ends in a pussy creampie" >
                        <img src="{{ URL::asset('images/movies/phim18.fun-marika-s-japan-girl-blowjob-ends-in-a-pussy-creampie.jpg') }}" width="356" height="200" alt="Marika's japan girl blowjob ends in a pussy creampie">
                        <div class="link-overlay glyphicon glyphicon-play-circle"></div>
                     </a>
                     <div class="item-head">
               ...
               <div class="video-item">
                  <div class="item-thumbnail">
                     <a href="movie/ruhime-maiori-is-nailed-in-dark-poonanie.1137.html" title="Ruhime Maiori is nailed in dark poonanie" >
                        <img src="{{ URL::asset('images/movies/phim18.fun-ruhime-maiori-is-nailed-in-dark-poonanie.jpg') }}" width="356" height="200" alt="Ruhime Maiori is nailed in dark poonanie">
                        <div class="link-overlay glyphicon glyphicon-play-circle"></div>
                     </a>
                     <div class="item-head">
            ...
            <div class="video-item">
               <div class="item-thumbnail">
                  <a href="movie/kaoru-natsuki-has-strong-fuck-of-nooky.1125.html" title="Kaoru Natsuki has strong fuck of nooky" >
                     <img src="{{ URL::asset('images/movies/phim18.fun-kaoru-natsuki-has-strong-fuck-of-nooky.jpg') }}" width="748" height="421" alt="Kaoru Natsuki has strong fuck of nooky">
                     <div class="link-overlay glyphicon glyphicon-play-circle"></div>
                  </a>
                  <div class="item-head">
               ...
               <div class="video-item">
                  <div class="item-thumbnail">
                     <a href="movie/saori-s-make-out-session-turns-into-hardcore-fucking.1090.html" title="Saori's Make out Session Turns into Hardcore Fucking" >
                        <img src="{{ URL::asset('images/movies/phim18.fun-saori-s-make-out-session-turns-into-hardcore-fucking.jpg') }}" width="356" height="200" alt="Saori's Make out Session Turns into Hardcore Fucking">
                        <div class="link-overlay glyphicon glyphicon-play-circle"></div>
                     </a>
                     <div class="item-head">
               ...
               <div class="video-item">
                  <div class="item-thumbnail">
                     <a href="movie/ruri-hayami-s-milf-pussy-gets-creampied-in-a-threesome.1105.html" title="Ruri Hayami's MILF Pussy Gets Creampied In A Threesome" >
                        <img src="{{ URL::asset('images/movies/phim18.fun-ruri-hayami-s-milf-pussy-gets-creampied-in-a-threesome.jpg') }}" width="356" height="200" alt="Ruri Hayami's MILF Pussy Gets Creampied In A Threesome">
                        <div class="link-overlay glyphicon glyphicon-play-circle"></div>
                     </a>
                     <div class="item-head">
               ...
               <div class="video-item">
                  <div class="item-thumbnail">
                     <a href="movie/two-guys-fuck-sana-anju-s-tight-holes-in-class.1107.html" title="Two Guys Fuck Sana Anju's Tight Holes In Class" >
                        <img src="{{ URL::asset('images/movies/phim18.fun-two-guys-fuck-sana-anju-s-tight-holes-in-class.jpg') }}" width="356" height="200" alt="Two Guys Fuck Sana Anju's Tight Holes In Class">
                        <div class="link-overlay glyphicon glyphicon-play-circle"></div>
                     </a>
                     <div class="item-head">
               ...
               <div class="video-item">
                  <div class="item-thumbnail">
                     <a href="movie/akina-hara-licks-and-sucks-two-shlongs.1044.html" title="Akina Hara licks and sucks two shlongs" >
                        <img src="{{ URL::asset('images/movies/phim18.fun-akina-hara-licks-and-sucks-two-shlongs.jpg') }}" width="356" height="200" alt="Akina Hara licks and sucks two shlongs">
                        <div class="link-overlay glyphicon glyphicon-play-circle"></div>
                     </a>
                     <div class="item-head">
            ...
            <div class="video-item">
               <div class="item-thumbnail">
                  <a href="movie/yuu-sakura-in-a-hot-horny-and-hardcore-action.1084.html" title="Yuu Sakura in a hot, horny and hardcore action" >
                     <img src="{{ URL::asset('images/movies/phim18.fun-yuu-sakura-in-a-hot-horny-and-hardcore-action.jpg') }}" width="748" height="421" alt="Yuu Sakura in a hot, horny and hardcore action">
                     <div class="link-overlay glyphicon glyphicon-play-circle"></div>
                  </a>
                  <div class="item-head">
               ...
               <div class="video-item">
                  <div class="item-thumbnail">
                     <a href="movie/toys-fucking-hina-maeda-s-pussy-makes-her-squirt.1083.html" title="Toys Fucking Hina Maeda's Pussy Makes Her Squirt" >
                        <img src="{{ URL::asset('images/movies/phim18.fun-toys-fucking-hina-maeda-s-pussy-makes-her-squirt.jpg') }}" width="356" height="200" alt="Toys Fucking Hina Maeda's Pussy Makes Her Squirt">
                        <div class="link-overlay glyphicon glyphicon-play-circle"></div>
                     </a>
                     <div class="item-head">
               ...
               <div class="video-item">
                  <div class="item-thumbnail">
                     <a href="movie/satomi-suzuki-busty-is-fucked-like-crazy.1046.html" title="Satomi Suzuki busty is fucked like crazy" >
                        <img src="{{ URL::asset('images/movies/phim18.fun-satomi-suzuki-busty-is-fucked-like-crazy.jpg') }}" width="356" height="200" alt="Satomi Suzuki busty is fucked like crazy">
                        <div class="link-overlay glyphicon glyphicon-play-circle"></div>
                     </a>
                     <div class="item-head">
               ...
               <div class="video-item">
                  <div class="item-thumbnail">
                     <a href="movie/mai-asahina-s-pussy-oozes-cum-after-a-threesome.1013.html" title="Mai Asahina's Pussy Oozes Cum After A Threesome" >
                        <img src="{{ URL::asset('images/movies/phim18.fun-mai-asahina-s-pussy-oozes-cum-after-a-threesome.jpg') }}" width="356" height="200" alt="Mai Asahina's Pussy Oozes Cum After A Threesome">
                        <div class="link-overlay glyphicon glyphicon-play-circle"></div>
                     </a>
                     <div class="item-head">
               ...
               <div class="video-item">
                  <div class="item-thumbnail">
                     <a href="movie/noriko-kago-gets-fondled-and-fucked-in-every-way.1011.html" title="Noriko Kago gets fondled and fucked in every way!" >
                        <img src="{{ URL::asset('images/movies/phim18.fun-noriko-kago-gets-fondled-and-fucked-in-every-way.jpg') }}" width="356" height="200" alt="Noriko Kago gets fondled and fucked in every way!">
                        <div class="link-overlay glyphicon glyphicon-play-circle"></div>
                     </a>
                     <div class="item-head">
