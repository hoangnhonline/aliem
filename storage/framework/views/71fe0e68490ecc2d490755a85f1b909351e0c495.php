...
<script type="text/javascript" src="<?php echo e(URL::asset('assets/js/123movies.min.js?v=2.2')); ?>"></script>
   ...
   <body>
      <?php if( \Request::route()->getName() == "news-detail"): ?>
      <div id="fb-root"></div>
         ...
         <div class="modal-dialog">
            <div class="modal-content">
               ...
               <div class="modal-body">
                  ...
                  <img src="<?php echo e(URL::asset('assets/images/fblogin.png')); ?>" width="350"  />                     
                  </p>
               </div>               
            </div>
         </div>
