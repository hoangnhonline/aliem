   ...
   <body>
      <div class="main">
         <header class="sidebar">
            <div class="container">
               <div class="logo header-item"><a href="<?php echo e(route('home')); ?>" title="phim18.fun"><img src="<?php echo e(URL::asset('assets/img/logo.png')); ?>" alt="phim18.fun" /></a></div>
         ...
         <div class="header-mobile">
            ...
            <a href="index.html" title="phim18.fun"><img src="<?php echo e(URL::asset('assets/img/logo.png')); ?>" alt="phim18.fun" /></a>
         </div>
         <div class="main-page">
            <?php echo $__env->yieldContent('bcrum'); ?>
      ...
      <link rel="stylesheet" type="text/css" href="<?php echo e(URL::asset('assets/css/bootstrap-theme.min.css')); ?>" />
      <link rel="stylesheet" type="text/css" href="<?php echo e(URL::asset('assets/css/style.min0c89.css')); ?>?_=20160405" />
      ...
      <!--[if lt IE 9]>
      <script type="text/javascript" src="<?php echo e(URL::asset('assets/js/respond.min.js')); ?>"></script>
      <![endif]-->
      <script type='text/javascript' src="<?php echo e(URL::asset('assets/js/ejs.min.js')); ?>"></script>
      <script type='text/javascript' src="<?php echo e(URL::asset('assets/js/jquery.cookie.js')); ?>"></script>		
      <script type="text/javascript" src="<?php echo e(URL::asset('assets/js/jquery.caroufredsel-6.2.1.min.js')); ?>"></script>
      <script type="text/javascript" src="<?php echo e(URL::asset('assets/js/jquery.touchSwipe.min.js')); ?>"></script>
      <script type="text/javascript" src="<?php echo e(URL::asset('assets/js/slider.js')); ?>"></script>
