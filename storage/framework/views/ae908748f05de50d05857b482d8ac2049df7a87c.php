...
<?php if(!Session::get('login')): ?>
  ...
  <div class="user-name">            
    ...
    <div class="user-name-link">       
      <ul>
        <li class="user-name-short"><span>Chào, <?php echo e(Session::get('username')); ?></span> <span class="caret"></span></li>        
      </ul>   

      <div class="user-name-box">                
        <ul class="user-ajax-customer">                      
          <li> <a href="<?php echo e(route('kho-phim')); ?>" title="Kho phim của tôi"> Kho phim của tôi </a> </li>
